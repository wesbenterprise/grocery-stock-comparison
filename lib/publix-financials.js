...
const UNREALIZED_SECURITIES_GL = {
  ...
  '2018-Q2':  77000000,
  '2018-Q3': 166000000,
  '2018-Q4':  -95000000,  // FY total $122M; Q4 = FY - Q1 - Q2 - Q3
  // FY2019
  '2019-Q1':  314000000,
  '2019-Q2':    5000000,
  '2019-Q3':  -27000000,
  '2019-Q4':  113000000,  // FY total $405M; Q4 = FY - Q1 - Q2 - Q3
  // FY2020
  '2020-Q1': -387000000,
  '2020-Q2':  597000000,
  '2020-Q3':  131000000,
  '2020-Q4':   28000000,  // FY total $369M; Q4 = FY - Q1 - Q2 - Q3
  // FY2021
  '2021-Q1':  785000000,
  '2021-Q2':  129000000,
  '2021-Q3':   73000000,
  '2021-Q4':   74000000,  // FY total $1061M; Q4 = FY - Q1 - Q2 - Q3
  // FY2022
  '2022-Q1': -581000000,
  '2022-Q2': -358000000,
  '2022-Q3': -556000000,
  '2022-Q4':  551000000,  // FY total -$944M; Q4 = FY - Q1 - Q2 - Q3
  // FY2023
  '2023-Q1':  246000000,
  '2023-Q2':  123000000,
  '2023-Q3': -144000000,
  '2023-Q4':  173000000,  // FY total $398M; Q4 = FY - Q1 - Q2 - Q3
  // FY2024
  '2024-Q1':  387000000,
  '2024-Q2':   43000000,
  '2024-Q3':  224000000,
  '2024-Q4':  134000000,  // FY total $788M; Q4 = FY - Q1 - Q2 - Q3
  // FY2025
  '2025-Q1': -223000000,
  '2025-Q2':  446000000,
  '2025-Q3':  272000000,
  '2025-Q4':  218000000,  // FY total $713M; Q4 = FY - Q1 - Q2 - Q3
};

const PUBLIX_TAX_RATE = 0.27; // blended effective rate FY2015–FY2025
...
export function getCellBackground(revenue, globalMin, globalMax) {
  const intensity = (revenue - globalMin) / (globalMax - globalMin);
  const alpha = 0.15 + intensity * 0.65;
  return `rgba(200, 160, 80, ${alpha.toFixed(3)})`;
}

export function getMinMax(revenueMatrix, visibleYears) {
  const values = revenueMatrix
